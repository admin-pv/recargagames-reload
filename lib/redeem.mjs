 ...
 */
export async function finishRedeem(cfg, { voucherId, attemptId, tid, productCode, pinDelivered }) {
...
const ATTEMPT_SELECT =
  ...
  "voucher:pv_vouchers!inner(id,code,status,redeemed_at)";
...
const PROCESSING_SELECT =
  "id,code,status," +
  "attempts:pv_redeem_attempts(id,attempt_number,product_code,result,lapak_tid,created_at)";
