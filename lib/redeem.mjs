...
const ATTEMPT_SELECT =
  ...
  "voucher:pv_vouchers!inner(id,code,status,redeemed_at,batch:pv_batches(locale,site_host))";
...
const PROCESSING_SELECT =
  "id,code,status," +
  "batch:pv_batches(locale,site_host)," +
...
const PENDING_EMAIL_SELECT =
  ...
  "voucher:pv_vouchers!inner(id,code,batch:pv_batches(locale,site_host))";
